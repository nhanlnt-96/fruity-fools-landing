...
import {ResponsiveWrapper, StyledButton, StyledLink, StyledRoundButton, truncate} from "./styleComponents";
  ...
  return (
    <Parallax bgImage={BgBanner} strength={500} className="banner-comp comp-height-with-parallax">
      ...
      <Container className="banner-comp-container d-flex justify-content-center align-items-center">
        ...
        <Row className="banner-comp-content justify-content-center">
          {
            blockchain.account ? (
              <div className="banner-comp-mint">
                <ResponsiveWrapper data-aos="zoom-in" flex={1} style={{padding: 24}} test>
                  <s.Container
                    flex={2}
                    jc={"center"}
                    ai={"center"}
              ...
              <div className="banner-comp-title">
                <h2 data-aos="flip-left" className="title">Fruity Fools collection is being introduced to the NFT
                  community</h2>
              </div>
            )
          }
